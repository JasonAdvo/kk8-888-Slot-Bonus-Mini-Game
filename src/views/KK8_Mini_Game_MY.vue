			...
			<div class="container">
						...
						<div class="Main_Game_Container">
							<div class="Game_Inner_Container">
								<div class="grid">
									...
									<button @click="startGame" class="middle-button">KLIK</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="Btm_Time_Chance_Container">
					<div class="Chance_Container">
						Ada ( {{ chancesLeft }} ) Peluang Percuma
					</div>
				...
				<div class="popup-card" v-if="showPopup">
					<div class="relative">
						...
						<img v-if="showLuckyImage" class="lucky" src="/Images/Lucky_MY.webp" alt="Lucky Reward">
					</div>
...
export default {
	...
	data() {
		return {
			boxes: [
				{ selectedImage: '/Images/888_Y_MY.webp', nonSelectedImage: '/Images/888_B_MY.webp', selected: false },
				{ selectedImage: '/Images/50_Y_MY.webp', nonSelectedImage: '/Images/50_B_MY.webp', selected: false },
				{ selectedImage: '/Images/retry_Y_MY.webp', nonSelectedImage: '/Images/retry_B_MY.webp', selected: false },
				{ selectedImage: '/Images/388_Y_MY.webp', nonSelectedImage: '/Images/388_B_MY.webp', selected: false },
				{ selectedImage: '/Images/200_Y_MY.webp', nonSelectedImage: '/Images/200_B_MY.webp', selected: false },
				{ selectedImage: '/Images/retry_Y_MY.webp', nonSelectedImage: '/Images/retry_B_MY.webp', selected: false },
				{ selectedImage: '/Images/Free_10_Y_MY.webp', nonSelectedImage: '/Images/Free_10_B_MY.webp', selected: false },
				{ selectedImage: '/Images/25_Y_MY.webp', nonSelectedImage: '/Images/25_B_MY.webp', selected: false },
			],
			notifications: [
				{
					image1: '/Images/Money_Bg.webp', image2: '/Images/CSY.webp', text: 'Tahniah pengguna xxx8422 menang 888% Bonus'
				},
				{
					image1: '/Images/Money_Bg.webp', image2: '/Images/Penguin.webp', text: 'Tahniah pengguna xxx1119 menang 888% Bonus'
				},
				{
					image1: '/Images/Money_Bg.webp', image2: '/Images/Mouse.webp', text: 'Tahniah penggunar xxx1306 menang 888% Bonus'
				},
				{
					image1: '/Images/Money_Bg.webp', image2: '/Images/Shark.webp', text: 'Tahniah pengguna xxx6769 menang 388% Welcome'
				},
				{
					image1: '/Images/Money_Bg.webp', image2: '/Images/Panda.webp', text: 'Tahniah pengguna xxx1729  menang 50% Bonus Slot Tanpa Had'
				},
			],
			currentIndex: 0,
			interval: null,
	...
	methods: {
		...
		startGame() {
			this.playBGM();
			// if (!this.isPlayingbgmSound) {
			// 	this.bgmSound = new Audio('/audio/Children Game Loop.wav');
			// 	this.bgmSound.currentTime = 0;
			// 	this.bgmSound.loop = true;
			// 	this.bgmSound.play();
			// 	this.isPlayingbgmSound = true;
			// }
			...
			setTimeout(() => {
				...
				if (finalIndex === 5) {
					this.popupMessage_1 = "Maaf! Sila Cuba Lagi! ";
					this.popupMessage_2 = "Masih Ada (1) Peluang Percuma";
					this.popupButtonText = "Cuba Lagi";
					this.showPopup = true;
					// Ensure lucky image is not shown
					this.showLuckyImage = false;
				} else if (finalIndex === 0) {
					this.popupMessage_1 = "Tahniah!";
					this.popupMessage_2 = "Dapat 888% Bonus!";
					this.popupButtonText = "Dapatkan Sekarang";
					this.showPopup = true;
